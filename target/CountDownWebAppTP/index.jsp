...
console.log(message);
		...
		function construct()
		{
			...
			document.getElementById('counters').innerHTML += 'Select your prefered localisation for the counter : <select id="language"><option value="Anglais Britannique">Anglais Britannique</option><option value="Anglais Americain">Anglais Americain</option><option value="Français">Français</option><option value="Russie">Russie</option></select><br />';
